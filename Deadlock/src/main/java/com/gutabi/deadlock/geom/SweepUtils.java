...
//	private static double sweepPointOverLine(Line still, Line moving) {
//		
//		Point a = still.p0;
//		Point b = still.p1;
//		
...
//		double cDistance = Point.dot(c.minus(a), norm);
//		double dDistance = Point.dot(d.minus(a), norm);
//		double cdParam = (0.0 - cDistance) / (dDistance - cDistance);
//		if (DMath.greaterThanEquals(cdParam, 0.0) && DMath.lessThanEquals(cdParam, 1.0)) {
//			Point p = Point.point(c, d, cdParam);
//			
//			double abParam = Point.u(a, p, b);
//			if (DMath.greaterThanEquals(abParam, 0.0) && DMath.lessThanEquals(abParam, 1.0)) {
//				assert DMath.equals(Point.distance(p, a, b), 0.0);
//				
//				return cdParam;
//			}	
//		}
...
//		
//		double[] params = new double[2];
//		int n = sweepPointOverPoint(a, moving, params);
//		
//		double adjustedCDParam;
////		if (n == 2) {
////			/*
...
//		 */
//		
//		n = sweepPointOverPoint(b, moving, params);
//		
////		if (n == 2) {
////			/*
////			 * figure out which to choose
...
//	}
	 ...
	 * 
	 */
//	private static int sweepPointOverPoint(Point still, Line moving, double[] params) {
//		
//		Point c = moving.p0;
//		Point d = moving.p1;
//		
//		double aCoeff = ((d.x - c.x)*(d.x - c.x) + (d.y - c.y)*(d.y - c.y));
//		double bCoeff = -2 * ((d.x - c.x)*(still.x - c.x) + (d.y - c.y)*(still.y - c.y));
//		double cCoeff = ((still.x - c.x)*(still.x - c.x) + (still.y - c.y)*(still.y - c.y));
//		double[] roots = new double[2];
//		double discriminant = DMath.quadraticSolve(aCoeff, bCoeff, cCoeff, roots);
//		if (DMath.equals(discriminant, 0.0)) {
//			/*
...
//			if (DMath.greaterThanEquals(cdParam, 0.0) && DMath.lessThanEquals(cdParam, 1.0)) {
//				Point cdPoint = Point.point(c, d, cdParam);
//				assert DMath.equals(Point.distance(still, cdPoint), 0.0);
//				
//				params[0] = cdParam;
//				return 1;
//			}
...
//			if (DMath.greaterThanEquals(cdParam0, 0.0) && DMath.lessThanEquals(cdParam0, 1.0)) {
//				Point cdPoint0 = Point.point(c, d, cdParam0);
//				assert DMath.equals(Point.distance(still, cdPoint0), 0.0);
//				
//				params[0] = cdParam0;
//				cdParam0Set = true;
//			}
...
//			if (DMath.greaterThanEquals(cdParam1, 0.0) && DMath.lessThanEquals(cdParam1, 1.0)) {
//				Point cdPoint1 = Point.point(c, d, cdParam1);
//				assert DMath.equals(Point.distance(still, cdPoint1), 0.0);
//				
//				if (cdParam0Set) {
//					params[1] = cdParam1;
//				} else {
