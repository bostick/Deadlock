...
//		if (s0 instanceof CompoundShape) {
//			
//			return ((CompoundShape)s0).contains(s1);
//			
//		} else if (s1 instanceof CompoundShape) {
//			
//			return ((CompoundShape)s1).contains(s0);
//			
//		} else if (s0 instanceof Circle) {
//			if (s1 instanceof AABB) {
//				return containsAC((AABB)s1, (Circle)s0);
//			} else if (s1 instanceof Circle) {
//				return containsCC((Circle)s0, (Circle)s1);
//			} else if (s1 instanceof Quad) {
//				return containsCQ((Circle)s0, (Quad)s1);
//			}
//		} else if (s0 instanceof Quad) {
//			if (s1 instanceof AABB) {
//				return containsAQ((AABB)s1, (Quad)s0);
//			} else if (s1 instanceof Circle) {
//				return containsCQ((Circle)s1, (Quad)s0);
//			} else if (s1 instanceof Quad) {
//				return containsQQ((Quad)s0, (Quad)s1);
//			}
//		}
//		
//		assert false;
...
//	}
//	
//	public static boolean containsAA(AABB a0, AABB a1) {
//		return DMath.lessThanEquals(a0.x, a1.x) && DMath.lessThanEquals(a1.brX, a0.brX) &&
//				DMath.lessThanEquals(a0.y, a1.y) && DMath.lessThanEquals(a1.brY, a0.brY);
//	}
//	
//	public static boolean containsAC(AABB a0, Circle c1) {
//		
//		if (!containsAA(a0, c1.aabb)) {
//			return false;
//		}
//		
//		double[] c1Projection = new double[2];
...
//		a0.projectN01(a0Projection);
//		c1.project(a0.n01, c1Projection);
//		if (!DMath.rangeContains(a0Projection, c1Projection)) {
//			return false;
//		}
//		
//		a0.projectN12(a0Projection);
...
//	}
//	
//	public static boolean containsCC(Circle c0, Circle c1) {
//		if (DMath.greaterThan(c1.radius, c0.radius)) {
//			return false;
//		}
//		double dist = Point.distance(c0.center, c1.center);
...
//	}
//	
//	public static boolean containsCQ(Circle c0, Quad q1) {
//		
//		if (!containsAA(c0.aabb, q1.aabb)) {
//			return false;
//		}
//		
//		double[] c0Projection = new double[2];
...
//		q1.projectN01(q1Projection);
//		c0.project(q1.getN01(), c0Projection);
//		if (!DMath.rangeContains(q1Projection, c0Projection)) {
//			return false;
//		}
//		
//		q1.projectN12(q1Projection);
...
//	}
//	
//	public static boolean containsQQ(Quad q0, Quad q1) {
//		
//		if (!containsAA(q0.aabb, q1.aabb)) {
//			return false;
//		}
//		
//		double[] q0Projection = new double[2];
...
//		q0.projectN01(q0Projection);
//		q1.project(q0.getN01(), q1Projection);
//		if (!DMath.rangeContains(q0Projection, q1Projection)) {
//			return false;
//		}
//		
//		q0.projectN12(q0Projection);
