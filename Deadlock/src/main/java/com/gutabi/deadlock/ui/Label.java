...
public class Label {
	...
	public void setDimension(double w, double h) {
		localAABB = APP.platform.createShapeEngine().createAABB(null, localAABB.x, localAABB.y, w, h);
	}
	...
	public void render() {
		...
		aabb = APP.platform.createShapeEngine().createAABB(null, ul.x, ul.y, localAABB.width, localAABB.height);
