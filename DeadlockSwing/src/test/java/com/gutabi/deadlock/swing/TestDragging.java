...
//		testPressed(new Point(357., 298.));
//		testDragged(new Point(355., 298.));
//		testDragged(new Point(354., 298.));
//		testDragged(new Point(351., 298.));
//		testDragged(new Point(349., 298.));
//		testDragged(new Point(346., 300.));
//		testDragged(new Point(341., 306.));
//		testDragged(new Point(333., 321.));
//		testDragged(new Point(326., 338.));
//		testDragged(new Point(322., 353.));
//		testDragged(new Point(318., 372.));
//		testDragged(new Point(318., 402.));
//		testDragged(new Point(318., 429.));
//		testDragged(new Point(337., 467.));
//		testDragged(new Point(352., 482.));
//		testDragged(new Point(379., 497.));
//		testDragged(new Point(393., 497.));
//		testDragged(new Point(456., 478.));
//		testDragged(new Point(496., 463.));
//		testDragged(new Point(532., 446.));
//		testDragged(new Point(577., 418.));
//		testDragged(new Point(628., 381.));
//		testDragged(new Point(707., 322.));
//		testDragged(new Point(734., 308.));
//		testDragged(new Point(757., 296.));
//		testDragged(new Point(779., 287.));
//		testDragged(new Point(804., 281.));
//		testDragged(new Point(826., 278.));
//		testDragged(new Point(859., 278.));
//		testDragged(new Point(871., 283.));
//		testDragged(new Point(896., 300.));
//		testDragged(new Point(908., 312.));
//		testDragged(new Point(924., 330.));
//		testDragged(new Point(936., 353.));
//		testDragged(new Point(951., 390.));
//		testDragged(new Point(955., 405.));
//		testDragged(new Point(955., 413.));
//		testDragged(new Point(955., 424.));
//		testDragged(new Point(941., 456.));
//		testDragged(new Point(926., 467.));
//		testDragged(new Point(909., 469.));
//		testDragged(new Point(849., 460.));
//		testDragged(new Point(780., 431.));
//		testDragged(new Point(722., 407.));
//		testDragged(new Point(602., 363.));
//		testDragged(new Point(545., 339.));
//		testDragged(new Point(505., 312.));
//		testDragged(new Point(472., 289.));
//		testDragged(new Point(390., 257.));
//		testDragged(new Point(361., 248.));
//		testDragged(new Point(322., 237.));
//		testDragged(new Point(307., 235.));
//		testDragged(new Point(296., 231.));
//		testDragged(new Point(287., 231.));
//		testDragged(new Point(273., 231.));
//		testDragged(new Point(264., 231.));
//		testDragged(new Point(260., 233.));
//		testDragged(new Point(255., 239.));
//		testDragged(new Point(249., 252.));
//		testDragged(new Point(247., 279.));
//		testDragged(new Point(247., 303.));
//		testDragged(new Point(247., 328.));
//		testDragged(new Point(250., 358.));
//		testDragged(new Point(272., 414.));
//		testDragged(new Point(287., 429.));
//		testDragged(new Point(299., 438.));
//		testDragged(new Point(314., 444.));
//		testDragged(new Point(355., 446.));
//		testDragged(new Point(396., 446.));
//		testDragged(new Point(434., 439.));
//		testDragged(new Point(472., 419.));
//		testDragged(new Point(574., 340.));
//		testDragged(new Point(614., 313.));
//		testDragged(new Point(645., 285.));
//		testDragged(new Point(668., 246.));
//		testDragged(new Point(687., 222.));
//		testDragged(new Point(706., 204.));
//		testDragged(new Point(723., 195.));
//		testDragged(new Point(743., 189.));
//		testDragged(new Point(762., 187.));
//		testDragged(new Point(779., 187.));
//		testDragged(new Point(796., 190.));
//		testDragged(new Point(811., 201.));
//		testDragged(new Point(842., 234.));
//		testDragged(new Point(860., 252.));
//		testDragged(new Point(873., 268.));
//		testDragged(new Point(891., 283.));
//		testDragged(new Point(910., 321.));
//		testDragged(new Point(936., 380.));
//		testDragged(new Point(940., 411.));
//		testDragged(new Point(937., 425.));
//		testDragged(new Point(929., 438.));
//		testDragged(new Point(911., 449.));
//		testDragged(new Point(880., 456.));
//		testDragged(new Point(835., 456.));
//		testDragged(new Point(680., 416.));
//		testDragged(new Point(596., 390.));
//		testDragged(new Point(503., 370.));
//		testDragged(new Point(432., 352.));
//		testDragged(new Point(380., 333.));
//		testDragged(new Point(351., 312.));
//		testDragged(new Point(287., 277.));
//		testDragged(new Point(265., 268.));
//		testDragged(new Point(245., 264.));
//		testDragged(new Point(234., 264.));
//		testDragged(new Point(228., 264.));
//		testDragged(new Point(215., 280.));
//		testDragged(new Point(211., 297.));
//		testDragged(new Point(207., 314.));
//		testDragged(new Point(207., 331.));
//		testDragged(new Point(204., 390.));
//		testDragged(new Point(204., 415.));
//		testDragged(new Point(207., 429.));
//		testDragged(new Point(218., 442.));
//		testDragged(new Point(306., 452.));
//		testDragged(new Point(349., 445.));
//		testDragged(new Point(406., 425.));
//		testDragged(new Point(524., 344.));
//		testDragged(new Point(564., 313.));
//		testDragged(new Point(597., 294.));
//		testDragged(new Point(624., 276.));
//		testDragged(new Point(649., 257.));
//		testDragged(new Point(682., 206.));
//		testDragged(new Point(693., 188.));
//		testDragged(new Point(706., 176.));
//		testDragged(new Point(719., 165.));
//		testDragged(new Point(736., 161.));
//		testDragged(new Point(753., 157.));
//		testDragged(new Point(772., 157.));
//		testDragged(new Point(789., 160.));
//		testDragged(new Point(803., 166.));
//		testDragged(new Point(816., 177.));
//		testDragged(new Point(827., 192.));
//		testDragged(new Point(845., 268.));
//		testDragged(new Point(852., 299.));
//		testDragged(new Point(858., 341.));
//		testDragged(new Point(862., 366.));
//		testDragged(new Point(867., 388.));
//		testDragged(new Point(867., 410.));
//		testDragged(new Point(867., 429.));
//		testDragged(new Point(861., 446.));
//		testDragged(new Point(852., 454.));
//		testDragged(new Point(837., 458.));
//		testDragged(new Point(716., 439.));
//		testDragged(new Point(494., 377.));
//		testDragged(new Point(424., 363.));
//		testDragged(new Point(357., 345.));
//		testDragged(new Point(312., 330.));
//		testDragged(new Point(289., 321.));
//		testDragged(new Point(280., 315.));
//		testDragged(new Point(275., 315.));
//		testDragged(new Point(274., 315.));
//		testDragged(new Point(273., 315.));
//		testDragged(new Point(270., 329.));
//		testDragged(new Point(270., 351.));
//		testDragged(new Point(267., 378.));
//		testDragged(new Point(267., 403.));
//		testDragged(new Point(267., 419.));
//		testDragged(new Point(267., 430.));
//		testDragged(new Point(272., 440.));
//		testDragged(new Point(280., 452.));
//		testDragged(new Point(298., 468.));
//		testDragged(new Point(326., 475.));
//		testDragged(new Point(361., 480.));
//		testDragged(new Point(434., 470.));
//		testDragged(new Point(473., 458.));
//		testDragged(new Point(508., 445.));
//		testDragged(new Point(531., 436.));
//		testDragged(new Point(548., 422.));
//		testDragged(new Point(577., 386.));
//		testDragged(new Point(596., 366.));
//		testDragged(new Point(614., 348.));
//		testDragged(new Point(650., 316.));
//		testDragged(new Point(665., 296.));
//		testDragged(new Point(679., 278.));
//		testDragged(new Point(692., 263.));
//		testDragged(new Point(704., 255.));
//		testDragged(new Point(732., 251.));
//		testDragged(new Point(752., 256.));
//		testDragged(new Point(779., 273.));
//		testDragged(new Point(824., 313.));
//		testDragged(new Point(839., 329.));
//		testDragged(new Point(856., 355.));
//		testDragged(new Point(870., 396.));
//		testDragged(new Point(880., 421.));
//		testDragged(new Point(886., 446.));
//		testDragged(new Point(886., 476.));
//		testReleased();
//
//		testPressed(new Point(1002., 440.));
//		testDragged(new Point(1002., 445.));
//		testDragged(new Point(1004., 453.));
//		testDragged(new Point(1004., 461.));
//		testDragged(new Point(1004., 468.));
//		testDragged(new Point(1001., 481.));
//		testDragged(new Point(991., 493.));
//		testDragged(new Point(976., 504.));
//		testDragged(new Point(961., 506.));
//		testDragged(new Point(944., 500.));
//		testDragged(new Point(929., 487.));
//		testDragged(new Point(911., 472.));
//		testDragged(new Point(884., 452.));
//		testDragged(new Point(844., 425.));
//		testDragged(new Point(803., 386.));
//		testDragged(new Point(774., 355.));
//		testDragged(new Point(722., 327.));
//		testDragged(new Point(684., 319.));
//		testDragged(new Point(657., 316.));
//		testDragged(new Point(608., 314.));
//		testDragged(new Point(571., 314.));
//		testDragged(new Point(526., 314.));
//		testDragged(new Point(496., 314.));
//		testDragged(new Point(472., 314.));
//		testDragged(new Point(447., 314.));
//		testDragged(new Point(423., 314.));
//		testDragged(new Point(396., 318.));
//		testDragged(new Point(363., 344.));
//		testDragged(new Point(343., 398.));
//		testDragged(new Point(341., 412.));
//		testDragged(new Point(341., 442.));
//		testDragged(new Point(341., 469.));
//		testDragged(new Point(355., 499.));
//		testDragged(new Point(375., 505.));
//		testDragged(new Point(402., 505.));
//		testDragged(new Point(429., 502.));
//		testDragged(new Point(505., 451.));
//		testDragged(new Point(571., 410.));
//		testDragged(new Point(620., 381.));
//		testDragged(new Point(664., 352.));
//		testDragged(new Point(710., 316.));
//		testDragged(new Point(799., 259.));
//		testDragged(new Point(825., 245.));
//		testDragged(new Point(886., 226.));
//		testDragged(new Point(918., 221.));
//		testDragged(new Point(947., 221.));
//		testDragged(new Point(975., 227.));
//		testDragged(new Point(1004., 239.));
//		testDragged(new Point(1043., 266.));
//		testDragged(new Point(1077., 302.));
//		testDragged(new Point(1098., 331.));
//		testDragged(new Point(1109., 354.));
//		testDragged(new Point(1114., 389.));
//		testDragged(new Point(1102., 443.));
//		testDragged(new Point(1078., 462.));
//		testDragged(new Point(1016., 505.));
//		testDragged(new Point(978., 525.));
//		testDragged(new Point(921., 546.));
//		testDragged(new Point(873., 555.));
//		testDragged(new Point(723., 510.));
//		testDragged(new Point(684., 482.));
//		testDragged(new Point(657., 456.));
//		testDragged(new Point(630., 397.));
//		testDragged(new Point(602., 358.));
//		testDragged(new Point(541., 291.));
//		testDragged(new Point(525., 270.));
//		testDragged(new Point(510., 260.));
//		testDragged(new Point(498., 256.));
//		testDragged(new Point(490., 256.));
//		testDragged(new Point(479., 256.));
//		testDragged(new Point(462., 261.));
//		testDragged(new Point(436., 273.));
//		testDragged(new Point(414., 282.));
//		testDragged(new Point(391., 291.));
//		testDragged(new Point(376., 299.));
//		testDragged(new Point(351., 320.));
//		testDragged(new Point(341., 333.));
//		testDragged(new Point(317., 366.));
//		testDragged(new Point(304., 381.));
//		testDragged(new Point(294., 391.));
//		testDragged(new Point(288., 403.));
//		testDragged(new Point(281., 447.));
//		testDragged(new Point(281., 477.));
//		testDragged(new Point(290., 505.));
//		testDragged(new Point(307., 542.));
//		testDragged(new Point(323., 578.));
//		testDragged(new Point(334., 596.));
//		testDragged(new Point(342., 603.));
//		testDragged(new Point(351., 605.));
//		testDragged(new Point(360., 598.));
//		testDragged(new Point(382., 574.));
//		testDragged(new Point(432., 540.));
//		testDragged(new Point(478., 504.));
//		testDragged(new Point(526., 442.));
//		testDragged(new Point(576., 389.));
//		testDragged(new Point(633., 342.));
//		testDragged(new Point(679., 285.));
//		testDragged(new Point(736., 210.));
//		testDragged(new Point(760., 191.));
//		testDragged(new Point(795., 165.));
//		testDragged(new Point(840., 133.));
//		testDragged(new Point(874., 110.));
//		testDragged(new Point(913., 99.));
//		testDragged(new Point(960., 93.));
//		testDragged(new Point(1061., 124.));
//		testDragged(new Point(1105., 149.));
//		testDragged(new Point(1137., 168.));
//		testDragged(new Point(1165., 185.));
//		testDragged(new Point(1183., 228.));
//		testDragged(new Point(1183., 249.));
//		testDragged(new Point(1171., 267.));
//		testDragged(new Point(1122., 295.));
//		testDragged(new Point(1066., 312.));
//		testDragged(new Point(990., 326.));
//		testDragged(new Point(915., 337.));
//		testDragged(new Point(752., 344.));
//		testDragged(new Point(701., 344.));
//		testDragged(new Point(632., 335.));
//		testDragged(new Point(571., 321.));
//		testDragged(new Point(531., 307.));
//		testDragged(new Point(499., 288.));
//		testDragged(new Point(406., 233.));
//		testDragged(new Point(377., 213.));
//		testDragged(new Point(360., 204.));
//		testDragged(new Point(336., 194.));
//		testDragged(new Point(327., 194.));
//		testDragged(new Point(316., 194.));
//		testDragged(new Point(302., 194.));
//		testDragged(new Point(277., 219.));
//		testDragged(new Point(265., 239.));
//		testDragged(new Point(259., 259.));
//		testDragged(new Point(254., 284.));
//		testDragged(new Point(252., 355.));
//		testDragged(new Point(252., 380.));
//		testDragged(new Point(253., 407.));
//		testDragged(new Point(262., 432.));
//		testDragged(new Point(275., 450.));
//		testDragged(new Point(293., 461.));
//		testDragged(new Point(310., 468.));
//		testDragged(new Point(327., 470.));
//		testDragged(new Point(381., 466.));
//		testDragged(new Point(437., 446.));
//		testDragged(new Point(492., 415.));
//		testDragged(new Point(541., 385.));
//		testDragged(new Point(609., 360.));
//		testDragged(new Point(708., 278.));
//		testDragged(new Point(743., 237.));
//		testDragged(new Point(814., 164.));
//		testDragged(new Point(850., 118.));
//		testDragged(new Point(875., 95.));
//		testDragged(new Point(903., 77.));
//		testDragged(new Point(980., 58.));
//		testDragged(new Point(1014., 58.));
//		testDragged(new Point(1045., 62.));
//		testDragged(new Point(1083., 82.));
//		testDragged(new Point(1125., 125.));
//		testDragged(new Point(1153., 156.));
//		testDragged(new Point(1174., 206.));
//		testDragged(new Point(1174., 239.));
//		testDragged(new Point(1168., 264.));
//		testDragged(new Point(1150., 285.));
//		testDragged(new Point(953., 412.));
//		testDragged(new Point(877., 426.));
//		testDragged(new Point(786., 437.));
//		testDragged(new Point(722., 444.));
//		testDragged(new Point(648., 444.));
//		testDragged(new Point(605., 440.));
//		testDragged(new Point(567., 432.));
//		testDragged(new Point(542., 420.));
//		testDragged(new Point(522., 414.));
//		testDragged(new Point(481., 407.));
//		testDragged(new Point(459., 407.));
//		testDragged(new Point(440., 407.));
//		testDragged(new Point(419., 413.));
//		testDragged(new Point(413., 420.));
//		testDragged(new Point(412., 427.));
//		testDragged(new Point(410., 441.));
//		testDragged(new Point(420., 517.));
//		testDragged(new Point(437., 545.));
//		testDragged(new Point(458., 561.));
//		testDragged(new Point(480., 570.));
//		testDragged(new Point(514., 574.));
//		testDragged(new Point(541., 574.));
//		testDragged(new Point(589., 561.));
//		testReleased();
//
//		testPressed(new Point(242., 263.));
//		testDragged(new Point(240., 265.));
//		testDragged(new Point(236., 266.));
//		testDragged(new Point(229., 269.));
//		testDragged(new Point(220., 271.));
//		testDragged(new Point(211., 275.));
//		testDragged(new Point(204., 278.));
//		testDragged(new Point(195., 282.));
//		testDragged(new Point(186., 286.));
//		testDragged(new Point(174., 290.));
//		testDragged(new Point(162., 298.));
//		testDragged(new Point(149., 306.));
//		testDragged(new Point(139., 319.));
//		testDragged(new Point(131., 328.));
//		testDragged(new Point(125., 341.));
//		testDragged(new Point(120., 348.));
//		testDragged(new Point(118., 354.));
//		testDragged(new Point(117., 358.));
//		testDragged(new Point(117., 365.));
//		testDragged(new Point(117., 373.));
//		testDragged(new Point(117., 389.));
//		testDragged(new Point(117., 408.));
//		testDragged(new Point(118., 422.));
//		testDragged(new Point(123., 432.));
//		testDragged(new Point(129., 439.));
//		testDragged(new Point(138., 443.));
//		testDragged(new Point(152., 447.));
//		testDragged(new Point(167., 449.));
//		testDragged(new Point(181., 451.));
//		testDragged(new Point(197., 451.));
//		testDragged(new Point(219., 451.));
//		testDragged(new Point(252., 451.));
//		testDragged(new Point(283., 447.));
//		testDragged(new Point(311., 440.));
//		testDragged(new Point(334., 431.));
//		testDragged(new Point(357., 415.));
//		testDragged(new Point(377., 397.));
//		testDragged(new Point(390., 382.));
//		testDragged(new Point(398., 374.));
//		testDragged(new Point(399., 370.));
//		testDragged(new Point(397., 365.));
//		testDragged(new Point(380., 359.));
//		testDragged(new Point(357., 353.));
//		testDragged(new Point(335., 346.));
//		testDragged(new Point(303., 339.));
//		testDragged(new Point(269., 328.));
//		testDragged(new Point(252., 319.));
//		testDragged(new Point(243., 316.));
//		testDragged(new Point(240., 313.));
//		testDragged(new Point(239., 312.));
//		testDragged(new Point(239., 309.));
//		testDragged(new Point(239., 308.));
//		testDragged(new Point(251., 292.));
//		testDragged(new Point(278., 275.));
//		testDragged(new Point(301., 262.));
//		testDragged(new Point(323., 253.));
//		testDragged(new Point(348., 246.));
//		testDragged(new Point(373., 244.));
//		testDragged(new Point(400., 241.));
//		testDragged(new Point(419., 241.));
//		testDragged(new Point(436., 241.));
//		testDragged(new Point(448., 244.));
//		testDragged(new Point(460., 250.));
//		testDragged(new Point(473., 263.));
//		testDragged(new Point(483., 281.));
//		testDragged(new Point(495., 301.));
//		testDragged(new Point(503., 318.));
//		testDragged(new Point(509., 330.));
//		testDragged(new Point(509., 339.));
//		testDragged(new Point(509., 343.));
//		testDragged(new Point(509., 349.));
//		testDragged(new Point(506., 354.));
//		testDragged(new Point(499., 357.));
//		testDragged(new Point(494., 359.));
//		testDragged(new Point(493., 362.));
//		testDragged(new Point(490., 363.));
//		testReleased();
//
//		testPressed(new Point(540., 327.));
//		testDragged(new Point(538., 327.));
//		testDragged(new Point(530., 327.));
//		testDragged(new Point(516., 327.));
//		testDragged(new Point(497., 322.));
//		testDragged(new Point(474., 313.));
//		testDragged(new Point(429., 300.));
//		testDragged(new Point(380., 287.));
//		testDragged(new Point(342., 279.));
//		testDragged(new Point(315., 277.));
//		testDragged(new Point(280., 281.));
//		testDragged(new Point(240., 295.));
//		testDragged(new Point(208., 311.));
//		testDragged(new Point(188., 324.));
//		testDragged(new Point(175., 337.));
//		testDragged(new Point(165., 350.));
//		testDragged(new Point(156., 367.));
//		testDragged(new Point(149., 395.));
//		testDragged(new Point(145., 417.));
//		testDragged(new Point(145., 433.));
//		testDragged(new Point(145., 444.));
//		testDragged(new Point(145., 456.));
//		testDragged(new Point(147., 462.));
//		testDragged(new Point(154., 468.));
//		testDragged(new Point(166., 474.));
//		testDragged(new Point(185., 476.));
//		testDragged(new Point(227., 476.));
//		testDragged(new Point(270., 468.));
//		testDragged(new Point(310., 454.));
//		testDragged(new Point(371., 437.));
//		testDragged(new Point(424., 414.));
//		testDragged(new Point(467., 371.));
//		testDragged(new Point(496., 336.));
//		testDragged(new Point(514., 308.));
//		testDragged(new Point(521., 288.));
//		testDragged(new Point(523., 254.));
//		testDragged(new Point(523., 227.));
//		testDragged(new Point(520., 207.));
//		testDragged(new Point(520., 196.));
//		testDragged(new Point(520., 194.));
//		testDragged(new Point(520., 193.));
//		testDragged(new Point(521., 193.));
//		testDragged(new Point(524., 193.));
//		testDragged(new Point(543., 201.));
//		testDragged(new Point(575., 225.));
//		testDragged(new Point(599., 255.));
//		testDragged(new Point(622., 280.));
//		testDragged(new Point(638., 298.));
//		testDragged(new Point(649., 318.));
//		testDragged(new Point(656., 338.));
//		testDragged(new Point(656., 357.));
//		testDragged(new Point(656., 374.));
//		testDragged(new Point(649., 381.));
//		testDragged(new Point(635., 385.));
//		testDragged(new Point(608., 385.));
//		testDragged(new Point(568., 378.));
//		testDragged(new Point(518., 345.));
//		testDragged(new Point(458., 309.));
//		testDragged(new Point(388., 272.));
//		testDragged(new Point(336., 231.));
//		testDragged(new Point(300., 185.));
//		testDragged(new Point(278., 151.));
//		testDragged(new Point(264., 134.));
//		testDragged(new Point(247., 123.));
//		testDragged(new Point(229., 114.));
//		testDragged(new Point(207., 112.));
//		testDragged(new Point(191., 112.));
//		testDragged(new Point(177., 112.));
//		testDragged(new Point(168., 115.));
//		testDragged(new Point(163., 119.));
//		testDragged(new Point(157., 129.));
//		testDragged(new Point(155., 151.));
//		testDragged(new Point(153., 178.));
//		testDragged(new Point(153., 205.));
//		testDragged(new Point(153., 235.));
//		testDragged(new Point(160., 278.));
//		testDragged(new Point(173., 308.));
//		testDragged(new Point(193., 329.));
//		testDragged(new Point(228., 351.));
//		testDragged(new Point(263., 364.));
//		testDragged(new Point(292., 374.));
//		testDragged(new Point(309., 374.));
//		testDragged(new Point(317., 374.));
//		testDragged(new Point(320., 372.));
//		testDragged(new Point(320., 359.));
//		testDragged(new Point(312., 337.));
//		testDragged(new Point(300., 308.));
//		testDragged(new Point(284., 290.));
//		testDragged(new Point(264., 279.));
//		testDragged(new Point(245., 279.));
//		testDragged(new Point(229., 298.));
//		testDragged(new Point(217., 327.));
//		testDragged(new Point(209., 360.));
//		testDragged(new Point(206., 428.));
//		testDragged(new Point(206., 478.));
//		testDragged(new Point(206., 534.));
//		testDragged(new Point(213., 572.));
//		testDragged(new Point(217., 591.));
//		testDragged(new Point(219., 598.));
//		testDragged(new Point(222., 598.));
//		testDragged(new Point(223., 598.));
//		testDragged(new Point(231., 565.));
//		testDragged(new Point(245., 494.));
//		testDragged(new Point(261., 407.));
//		testDragged(new Point(272., 326.));
//		testDragged(new Point(283., 246.));
//		testDragged(new Point(290., 213.));
//		testDragged(new Point(294., 196.));
//		testDragged(new Point(296., 192.));
//		testDragged(new Point(297., 192.));
//		testDragged(new Point(298., 192.));
//		testDragged(new Point(300., 226.));
//		testDragged(new Point(303., 267.));
//		testDragged(new Point(305., 302.));
//		testDragged(new Point(309., 365.));
//		testDragged(new Point(311., 395.));
//		testDragged(new Point(313., 417.));
//		testDragged(new Point(313., 423.));
//		testDragged(new Point(315., 426.));
//		testDragged(new Point(315., 427.));
//		testDragged(new Point(315., 428.));
//		testDragged(new Point(321., 389.));
//		testDragged(new Point(333., 344.));
//		testDragged(new Point(348., 299.));
//		testDragged(new Point(367., 252.));
//		testDragged(new Point(383., 229.));
//		testDragged(new Point(395., 226.));
//		testDragged(new Point(410., 233.));
//		testDragged(new Point(421., 256.));
//		testDragged(new Point(431., 284.));
//		testDragged(new Point(443., 339.));
//		testDragged(new Point(455., 378.));
//		testDragged(new Point(464., 403.));
//		testDragged(new Point(472., 418.));
//		testDragged(new Point(477., 423.));
//		testDragged(new Point(483., 423.));
//		testDragged(new Point(492., 417.));
//		testDragged(new Point(506., 391.));
//		testDragged(new Point(533., 337.));
//		testDragged(new Point(551., 310.));
//		testDragged(new Point(566., 292.));
//		testDragged(new Point(579., 283.));
//		testDragged(new Point(590., 283.));
